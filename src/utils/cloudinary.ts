// A function to handle selecting an image from folder
...
// A function to handle uploading an image to cloudinary
...
// A function to handle deleting an image from cloudinary
...
// A function to handle generating an API signature for cloudinary delete function
