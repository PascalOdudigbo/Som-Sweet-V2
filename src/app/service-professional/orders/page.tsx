...
import { getAllOrders, updateOrderStatusAdmin } from '@/utils/orderManagementServiceprofessional'
import './_orders.scss'

function OrdersManagement() {
  // Defining state variables to manage dynamic data
  ...
  // A function to fetch all the orders
  const fetchOrders = async () => {
    try {
      // Utilizing the util function to get all customer orders
  ...
  useEffect(() => {
    // Utilizing the hook to implement the search functionality
  ...
  // OnChange function for the search component
