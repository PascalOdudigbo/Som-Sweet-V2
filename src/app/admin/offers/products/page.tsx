...
import { Loading, OfferProductsRow, Search } from '@/components'
...
export default function OfferProductsPage() {
    // Getting the discountID from the next params hook 
    ...
    // Implementing the search functionality for the productsusing hook
    useEffect(() => {
    ...
    // OnChange handler for the search component
    const handleSearch = (term: string) => {
        setSearchTerm(term);
    };

    // OnClick handler for the product delete functionality
