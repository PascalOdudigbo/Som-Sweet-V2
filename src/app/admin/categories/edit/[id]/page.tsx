...
function EditCategory({ params }: { params: { id: string } }) {
    ...
    // The router variable function
    const router = useRouter()
    // The upload image imput reference 
    const uploadImageRef = useRef<HTMLInputElement>(null)

    useEffect(() => {
        // A function to handle getting the categories data
        const fetchCategory = async () => {
            try {
                // Getting the categories dtaa from apu using util function
    ...
    // A function to handle editting category
    ...
    // If the category data couldn't be fetched then display loading component
