...
function AddProduct() {
  // Definin state variables for dynamic data management
  ...
  useEffect(() => {
    // A function for fetching the categories data using the utils function
  ...
  // On click function for adding a product 
  ...
  // A finction to handle product image change
  ...
  // Removing a selected image from the image array
