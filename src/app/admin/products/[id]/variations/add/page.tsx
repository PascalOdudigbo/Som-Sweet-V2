...
function AddVariation({ params }: { params: { id: string } }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // using the util function to create the variation
            ...
            // In the eventuality of the insert failing
